...
dependencies {
    implementation(platform("androidx.compose:compose-bom:2025.05.00")); implementation("androidx.core:core-ktx:1.16.0"); implementation("androidx.activity:activity-compose:1.10.1"); implementation("androidx.compose.material3:material3"); implementation("androidx.compose.material:material-icons-extended"); implementation("androidx.compose.runtime:runtime-livedata"); implementation("androidx.lifecycle:lifecycle-runtime-compose:2.9.0")
